<a class="btn btn-danger" id="bulk_delete_btn"><i class="voyager-trash"></i> <span>{{ __('Массовое удаление') }}</span></a>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">
                    <i class="voyager-trash"></i> {{ __('Вы уверены?') }} <span id="bulk_delete_count"></span> <span id="bulk_delete_display_name"></span>?
                </h4>
            </div>
            ...
            <div class="modal-footer">
                <form action="{{ route('voyager.'.$dataType->slug.'.index') }}/0" id="bulk_delete_form" method="POST">
                    ...
                    <input type="submit" class="btn btn-danger pull-right delete-confirm"
                             value="{{ __('Да, подтердить удаление') }} {{ strtolower($dataType->getTranslatedAttribute('display_name_plural')) }}">
                </form>
