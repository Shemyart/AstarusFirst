        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('equipment') }}" :active="request()->routeIs('dashboard')">
                        {{ __('Оборудование') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('projects') }}" :active="request()->routeIs('dashboard')">
                        {{ __('Проекты') }}
                    </x-jet-nav-link>
