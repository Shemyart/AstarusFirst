!function(){if("function"==typeof window.CustomEvent)return!1;
    window.CustomEvent=function(t,i){i=i||{bubbles:!1,cancelable:!1,detail:null};
        var e=document.createEvent("CustomEvent");return e.initCustomEvent(t,i.bubbles,i.cancelable,i.detail),e}}();
var WRAPPER_SELECTOR=".slider__wrapper",ITEMS_SELECTOR=".slider__items",
    ITEM_SELECTOR=".slider__item",CONTROL_CLASS="slider__control",
    ...
    CLASS_CONTROL_HIDE="slider__control_hide",CLASS_ITEM_ACTIVE="slider__item_active",
    CLASS_INDICATOR_ACTIVE="active";function ChiefSlider(t,i){var e="string"==typeof t?document.querySelector(t):t;
        for(var s in this._$root=e,this._$wrapper=e.querySelector(WRAPPER_SELECTOR),
            this._$items=e.querySelector(ITEMS_SELECTOR),this._$itemList=e.querySelectorAll(ITEM_SELECTOR),
            this._$controlPrev=e.querySelector(SELECTOR_PREV),this._$controlNext=e.querySelector(SELECTOR_NEXT),
            this._$indicatorList=e.querySelectorAll(SELECTOR_INDICATOR),this._minOrder=0,this._maxOrder=0,
            this._$itemWithMinOrder=null,this._$itemWithMaxOrder=null,this._minTranslate=0,this._maxTranslate=0,
            this._direction="next",this._balancingItemsFlag=!1,this._activeItems=[],this._transform=0,this._hasSwipeState=!1,
            this.__swipeStartPos=0,this._transform=0,this._intervalId=null,
            this._config={loop:!0,autoplay:!1,interval:5e3,refresh:!0,swipe:!0},i)this._config.hasOwnProperty(s)&&(this._config[s]=i[s]);
        ...
        for(var h=0,_=r.length;h<_;h++)r[h].dataset.index=h,r[h].dataset.order=h,
            r[h].dataset.translate=0,h<o&&this._activeItems.push(h);
        if(this._config.loop){var l=r.length-1,d=100*-r.length;
            r[l].dataset.order=-1,r[l].dataset.translate=100*-r.length,
                r[l].style.transform="translateX("+d+"%)",
                this.__refreshExtremeValues()}else this._$controlPrev&&this._$controlPrev.classList.add(CLASS_CONTROL_HIDE);
        this._setActiveClass(),this._addEventListener(),this._updateIndicators(),
            this._autoplay()}ChiefSlider.prototype._addEventListener=function(){
        var t=this._$root,i=this._$items,e=this._config;
        function s(t){this._autoplay("stop");
